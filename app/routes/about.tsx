  ...
  return (
    <div className="text-center text-lg">
      <h1
        ...
        className="text-2xl lg:text-3xl text-white py-8 lg:py-16 px-4"
      >
        Fresh, Local Flowers from North Berwick, Maine
      </h1>

      <img
        className="object-cover lg:float-right w-full lg:w-3/5 xl:w-2/5 lg:ml-4 lg:mt-6 mb-2"
        src="/raw-images/tearsa.webp"
        alt="Tearsa with flowers"
      />

      <h2 className="pt-4 px-4">Hi, I'm Tearsa, and I was raised on a farm.</h2>
