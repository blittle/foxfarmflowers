...
export default function ProductDetailPage() {
  ...
  return (
    <>
      <div className="flex lg:flex-row flex-col-reverse pt-8 lg:pt-0">
        ...
        <div className="w-full lg:w-1/2 lg:pl-4 px-4 lg:pr-0 text-center lg:text-left">
          ...
          />
          <button
            className="bg-fox-green text-white rounded py-2 px-12 opacity-60 mt-4 lg:mt-8"
            disabled
          >
            Coming soon!
          </button>
      ...
      <h2 className="montagu text-2xl text-center fox-green font-bold mb-8 mt-16">
        CSA FAQ
      </h2>
